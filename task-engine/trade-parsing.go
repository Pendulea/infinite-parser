...
// func addTradeParsingRunnerProcess(runner *gorunner.Runner, set *setlib.Set) {
// 	process := func() error {
// 		date := getDate(runner)
...
// func buildTradeParsingRunner(set *setlib.Set, concernedAssets setlib.AssetStates, date string) *gorunner.Runner {
// 	runner := gorunner.NewRunner(TRADE_PARSING_KEY + "-" + set.ID() + "-" + date)
...
// 	addTradeParsingRunnerProcess(runner, set)
// 	return runner
// }
